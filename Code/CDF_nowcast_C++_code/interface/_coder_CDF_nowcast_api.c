...
void CDF_nowcast_api(const mxArray * const prhs[1], int32_T nlhs, const mxArray *
                     plhs[1])
{
  real_T count;
  ...
  count = CDF_nowcast(count);

  /* Marshall function outputs */
  plhs[0] = emlrt_marshallOut(count);
}

void CDF_nowcast_atexit(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
  ...
  CDF_nowcast_xil_terminate();
}

void CDF_nowcast_initialize(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
void CDF_nowcast_terminate(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
/* End of code generation (_coder_CDF_nowcast_api.c) */
